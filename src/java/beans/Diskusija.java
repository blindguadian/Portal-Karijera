...
public class Diskusija {
    private String datumPostavljanja, nazivDiskusije, tekstDiskusije, kategorijaDiskusije, nivoVidljivosti, autorDiskusije, arhiviranaDiskusija, poruka, metaDiskusija, procitana, prviKomentar;
